...
//  Architechik
//
//  Created by Александр Цветков on 13.02.2021.
...
class NetworkSpeedTest: UIViewController {
    ...
    func networkSpeedTestStart(UrlForTestSpeed:String!){
        ...
        timerForSpeedTest = Timer.scheduledTimer(timeInterval: 3.0, target: self, selector: #selector(testForSpeed), userInfo: nil, repeats: true)
    }

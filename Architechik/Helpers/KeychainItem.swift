...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "mikel.Shmonov.Architechik", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "mikel.Shmonov.Architechik", account: "userIdentifier").deleteItem()
        } catch {
